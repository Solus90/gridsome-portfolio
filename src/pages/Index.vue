    ...
    <div class="overflow-x-hidden border-gray-200 border-b">
      <div class="get-to-know-me container-inner mx-auto text-xl pb-16 relative">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-center mb-16">
          ...
          <div class="flex-1 text-lg sm:text-xl ml-0 md:ml-6">Front-end developer with 4 years of experience in HTML, CSS, and responsive design. 
            I am a Dad and an avid reader. Experienced with most front-end technologies as well as various content management systems.  Big believer in JAMstack.</div>
        </div>
